        ...
        <div className='bg-white w-4/6 h-4/5 p-3 absolute top-1/2 left-1/2 z-10 transform -translate-x-1/2 -translate-y-1/2 shadow-lg rounded-[60px]'>
          ...
          <div className='w-full h-full '>
            ...
            <div className='w-5/12 relative left-[57%] flex flex-col gap-10 items-center p-4 bottom-[80%] '>
              ...
              <div className=''>
                {
                  image ? (
                    // 👉 Show image preview
                    <img src={image} className='size-45 border-4 rounded-full border-violet-300' />
                  ) : authUser?.user?.profilePic ? (
                    // 👉 Show image from DB if exists
                    <img src={authUser.user.profilePic} className='size-45 border-4 rounded-full border-violet-300' />
                  ) : (
                    // 👉 Show default icon
                    <img src={assets.userIcon} className='size-45 border-4 rounded-full border-violet-300' />
                  )
                }
              ...
              <div className='w-4/6 border-2 border-gray-300 p-3 text-start rounded-2xl'>
              ...
              <button onClick={handleUpdateProfile} className="btn btn-wide">Save</button>
